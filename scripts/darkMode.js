...
button.addEventListener("click", function() {
  ...
  if (button.innerHTML === "Light Theme?") {
    ...
    root.style.setProperty("--uiColor", "#6dd5fa");
    root.style.setProperty("--hrColor", "#222");
    root.style.setProperty("--writingTextTitle", "#2980b9");
    ...
    root.style.setProperty("--backgroundcol", "linear-gradient(to right, #203a43, #2c5364, #000000)");
    ...
    root.style.setProperty("--uiColor", "#19B288");
    root.style.setProperty("--hrColor", "#000");
    root.style.setProperty("--writingTextTitle", "#19B288");
